 ...
 * @author Hoang Long
 */
@WebServlet(name = "SearchOrder", urlPatterns = {"/search-order"})
public class SearchOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String sellId_raw = request.getParameter("sellId");
        if(year.isEmpty()){
            year = null;
        }
        if(month.isEmpty()){
        ...
        try {
            ...
            List<Order> list = dao.getAllOrderBySellerByDate(sellId, year, month, day);
            for (Order o : list) {
