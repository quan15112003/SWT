...
<html>
    <head>
        ...
        <title>RiaShop- Adding Size</title>
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="container-fluid pt-5">
                            <div class="text-center mb-4">
                                <h2 class="section-title px-5"><span class="px-2">Adding Size</span></h2>
                            </div>
                                        ...
                                        <form action="add-size" method="post" >
                                            <div class="control-group">
                                                <input type="text" class="form-control" name="name" id="name" placeholder="Size name"
                                                       required="required" data-validation-required-message="Please enter your size name" />
                                                <p class="help-block text-danger"></p>
                                            </div>

                                            <div>
                                                <input class="btn btn-primary py-2 px-4" type="submit" value="Add Size"></>
                                            </div>
                                        </form>
                                    </div>
                                </div>
