...
<html>
    <head>
        ...
        <title>RiaShop- ManageMaterial</title>
                        ...
                        <div class="row  py-2 ">
                            ...
                            <div class="col-lg-6 text-center text-lg-right">
                                <div class="d-inline-flex align-items-center">
                                    <a href="add-material">
                                            <button class="btn btn-sm btn-primary">Add a Material</button>
                                        </a>
                                </div>
                                    ...
                                    <tbody class="align-middle " >
                                        <c:forEach items="${list}" var="o">
                                            <tr class="item">
                                                ...
                                                <td class="align-middle"><a href="delete-material?mId=${o.id}" ><button class="btn btn-sm btn-primary"><i class="fa fa-times"></i></button></a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
