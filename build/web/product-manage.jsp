                    ...
                    <div class="col-lg-9">
                        <div class="row  py-2 ">
                            ...
                            <div class="col-lg-6 text-center text-lg-right">
                                ...
                                <div class="d-inline-flex align-items-center">
                                    <a href="delete-all-product">
                                        <button class="btn btn-sm btn-primary">Delete all Product</button>
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <tbody class="align-middle " >
                                        <c:forEach items="${list}" var="o">
                                            <tr class="item">
                                                ...
                                                <td class="align-middle">${o.mat.name}</td>
                                                <td class="align-middle">${o.size.name}</td>
                                                <td class="align-middle"><a href="delete-product?pId=${o.id}&sizeId=${o.size.id}&matId=${o.mat.id}" ><button class="btn btn-sm btn-primary"><i class="fa fa-times"></i></button></a></td>
                                                <td class="align-middle"><a href="edit-product?pId=${o.id}&sizeId=${o.size.id}&matId=${o.mat.id}" ><button class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></button></a></td>
                                                <td class="align-middle"><a href="add-type-product?pId=${o.id}" ><button class="btn btn-sm btn-primary"><i class="fa fa-plus"></i></button></a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
