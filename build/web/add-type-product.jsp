    ...
    <body>
        ...
        <div class="container-fluid pt-5">
            <div class="text-center mb-4">
                <h2 class="section-title px-5"><span class="px-2">Adding New Type Product</span></h2>
            </div>
            <div class="row px-xl-5">
                <div class="col-lg-7 mb-5">
                    <div class="contact-form">
                        <div id="success"></div>
                        <form action="add-type-product" method="post" >
                            <div class="control-group">
                                <input type="text" class="form-control" name="id"
                                       readonly="" value="${p.id}"  />
                            </div>
                            <div class="control-group">
                                <input type="text" class="form-control" readonly="" value="${p.name}" name="name" id="name" placeholder="Product name"
                            ...
                            <div class="control-group">
                                <input type="file" class="form-control" readonly="" value="${p.image}"  name="image" id="image" placeholder="Image"
                                       required="required" data-validation-required-message="Please upload your image " />
                                <p class="help-block text-danger"></p>
                            </div>

                            <div class="control-group">
                                <textarea class="form-control" rows="6" readonly="" name="description" id="description" placeholder="Description"
                                          required="required"
                                          data-validation-required-message="Please enter your description">${p.description}</textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <select class="form-control" name="category" disabled="" required="required" data-validation-required-message="Please choose your category">
                                    <c:forEach items="${listC}" var="o">
                                        <option <c:if test="${p.cate.id == o.id}">checked</c:if> value="${o.id}">${o.name}</option>
                                    </c:forEach>
                                </select>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <select class="form-control" name="size"  required="required" data-validation-required-message="Please choose your size">
                                    <c:forEach items="${listS}" var="o">
                                        <option <c:if test="${p.size.id == o.id}">checked</c:if> value="${o.id}">${o.name}</option>
                                    </c:forEach>
                                </select>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <select class="form-control" name="material" required="required" data-validation-required-message="Please choose your material">
                                    <c:forEach items="${listM}" var="o">
                                        <option <c:if test="${p.mat.id == o.id}">checked</c:if> value="${o.id}">${o.name}</option>
                                    </c:forEach>
                                </select>
                                <p class="help-block text-danger"></p>
                            </div> 
                            ...
                            <div>
                                <input class="btn btn-primary py-2 px-4" type="submit" value="Add Type Product"></>
                            </div>
                        </form>
                    </div>
                </div>
